...
Class selection in very crude at the moment; it takes all classes with greated than 19% of the particles.  This will be replaced with more robust class selection (using Cinderella) in later versions. 
