...
subprocess.call(['/fbs/emsoftware2/env-modules/install/crYOLO/1.3.5/bin/cryolo_predict.py','-c','config.json','-w',model,'-i','{0}/'.format(indir),'-g','0,1','-o',outdir,'-t','0.3'],stderr=FNULL)
